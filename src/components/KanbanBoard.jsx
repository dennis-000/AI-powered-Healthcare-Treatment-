...
const defaultTasks =
  ...
  // Function to delete a column and its associated tasks
  ...
  // Handle drag end events and rearrange columns or tasks
  function onDragEnd(event) {
    ...
    if (isActiveAColumn) {
      ...
      handleTaskRearrangement(active, over);
    }
  }

  // Handle drag-over events for rearranging tasks
  ...
  function handleTaskRearrangement(active, over) {
