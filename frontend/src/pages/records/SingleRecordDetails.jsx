...
const SingleRecordDetails = () => {
  ...
  return (
    <div className='flex flex-wrap gap-[26px]'>
      ...
      {/* File upload modal */}
      <RecordDetailsHeader recordName={state?.recordName || state?.name || 'Unknown Record'}/>
                ...
                <div className='flex w-full flex-col px-6 py-4 text-white'>
                  <div>
                    ...
                    <div className='space-y-2'>
                        {state?.analysisResult || 'No analysis available yet. Upload a medical report to get started.'}
                    </div>
                  </div>
